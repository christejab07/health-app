...
const Footer = () => {
  return (
    <div className='flex flex-row max-sm:flex-col'>
      <div className='bg-blue-400 flex flex-col w-[33.33%] max-md:w-full px-10 py-5 max-md:text-sm '>
      ...
      <div className='bg-blue-600 flex flex-col w-[33.33%] max-md:w-full px-10 py-5 max-md:text-sm'>
      ...
      <div className='bg-blue-800 flex flex-col w-[33.33%] max-md:w-full px-10 py-5 max-md:text-sm'>
